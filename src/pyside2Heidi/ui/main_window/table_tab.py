...
from PySide2.QtWidgets import QCheckBox, QComboBox, QTableWidgetItem, QTableWidgetSelectionRange, QTreeWidgetItem
...
class TableTab:
	...
	def updateUI(self):
		...
		mainWindow.txtCreateCode.setPlainText(str(table))
